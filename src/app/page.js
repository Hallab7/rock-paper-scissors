        ...
        <div className="grid grid-cols-2 gap-10 relative">
          {choices.map((choice, index) => (
            <div
              ...
              className={`bg-[#fafafa] w-32 h-32 rounded-full border-[12px] flex justify-center items-center cursor-pointer transition-transform transform hover:scale-110 ${choice.border}`}
            >
              <Image
                src={choice.image}
                alt={choice.name}
